...
router.post('/', authMiddleware, validate(createDiscountCodeSchema), createDiscountCode);
router.patch('/:id', authMiddleware, validate(updateDiscountCodeSchema), updateDiscountCode);
